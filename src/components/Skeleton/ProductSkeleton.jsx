      ...
      <div className="w-full">
        <div className="bg-gray-200 pb-[55px]! px-3! pt-4! rounded relative animate-pulse">
          <div className="flex items-center justify-between">
            ...
            <span className="px-3! py-2! rounded bg-gray-300 inline-block font-poppins text-sm font-normal w-16 h-6 mb-2!"></span>
          ...
          <div className="opacity-0 absolute left-0 bottom-0 font-poppins font-medium text-lg cursor-pointer flex justify-center items-center w-full h-12 bg-gray-300"></div>
        </div>
